...
public class FabricExecuteWithParams implements FabircExecuteOperation{
    ...
    public String execute(FabricOperationModel fabricOpModel, String... args) throws Exception {
        ...
        transction.submit(args) ;    
        gateway.close();
        return String.format("Chaincode % function executed successfully!", fabricOpModel.getFuncName());
